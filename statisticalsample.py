...
def trial_average(trialf, n, trial_args=None):
    total, trial_args = 0, trial_args if trial_args else []
    for i in range(n):
        total += trialf(*trial_args)
    return total / n
...
# In the famous Monty Hall game show, follow the strategy of switching.
